...
import { 
    LayoutDashboard, FileText, BarChart2, Users, Settings, LogOut, UserCog
} from 'lucide-react';
...
const Sidebar = () => {
    ...
    useEffect(() => {
        ...
        const handleProfileUpdate = () => {
            const updatedName = localStorage.getItem('adminName');
            if (updatedName) {
        ...
        // Fetch admin profile if name is not in localStorage
        ...
        <>
            ...
            <aside className="w-64 flex-shrink-0 bg-green-800 text-white flex flex-col h-screen fixed">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <NavLink icon={<UserCog size={20} />} label="ASSIGN STAFF" path="/AssignStaff" />
